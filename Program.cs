//1) + факториал без рекурсии
//2) + Фибоначчи без рекурсии
//3) ввод разных параметров и построение фигуры на их основе
//4) угадывание числа: пользователь загадывает число от 1 до 99,
// а машина пытается угадать
